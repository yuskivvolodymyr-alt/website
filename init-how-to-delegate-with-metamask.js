/**
 * How To Delegate - Complete Script with MetaMask Support
 * CSP Compliant - No inline scripts or event handlers
 * 
 * IMPORTANT: This version ADDS MetaMask support WITHOUT breaking existing functionality
 */

const chainId = 'qubetics_9030-1';

// Wallet connection function (UPDATED to support MetaMask)
async function connectWallet(walletType) {
    ...
    try {
        ...
        // Reset button content based on wallet type
        const resetContent = {
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('✅ How To Delegate Page Initialized (with MetaMask support)');
    
    // Keplr Guide link (UNCHANGED)
    ...
    // Cosmostation Guide link (UNCHANGED)
    ...
    // Connect Keplr button (UNCHANGED)
    ...
    // Connect Cosmostation button (UNCHANGED)
    ...
    // Keplr Modal - close on click outside (UNCHANGED)
    ...
    // Cosmostation Modal - close on click outside (UNCHANGED)
    ...
    // Close modals with ESC key (UNCHANGED)
    ...
    console.log('✅ All event listeners attached successfully (including MetaMask)');
});
