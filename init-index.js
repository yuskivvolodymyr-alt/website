...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Header Wallet Button - toggle dropdown
    ...
    if (headerWalletBtn) {
        ...
        console.log('✅ headerWalletBtn listener attached');
    }
    
    // Header Keplr Option
    const headerKeplrOption = document.getElementById('headerKeplrOption');
    if (headerKeplrOption) {
        headerKeplrOption.addEventListener('click', function() {
            connectHeaderWallet('keplr');
        });
        console.log('✅ headerKeplrOption listener attached');
    }
    
    // Header Cosmostation Option
    const headerCosmostationOption = document.getElementById('headerCosmostationOption');
    if (headerCosmostationOption) {
        headerCosmostationOption.addEventListener('click', function() {
            connectHeaderWallet('cosmostation');
        });
        console.log('✅ headerCosmostationOption listener attached');
    }
